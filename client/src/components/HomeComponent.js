      ...
      <Fade in duration={200}>
        <div className="home-header">
          <div className="d-md-flex">
            <div onClick={() => setStopped((prev) => !prev)}>
              <Lottie
          ...
          <h2 className="font-weight-light">
            the movie database for all your movie needs!
          </h2>
        </div>
      </Fade>
      <FadeTransform
        transformProps={{ exitTransform: "translateY(-100px)" }}
        duration={400}
        in
      >
        <Container>
            ...
            <Col xs>
              <div className="home-body">
                ...
                <Form
                  ...
                  inline="true"
                  onSubmit={(e) => search(e, homeSearchRef.current.value)}
                >
                  <input
